  ...
  <div>
    <div style="width:100%;backgroundColor:#ebebeb;padding:30px;height:100vh;">
      <div style="minWidth:350px;width:40%;margin:auto;">
        <div
          style="marginBottom:15px;fontSize:18px;fontWeight:bold;color:#293f5f;"
        >
          hahah
        </div>
        <div
          style="width:100%;height:100%;backgroundColor:#ffffff;margin:auto;;padding:40px 20px;fontSize:14px;"
        >
          ...
          <div style="margin:auto;marginTop:30px;">
            <div
              style="width:130px;height:40px;line-Height:40px;fontSize:15px;
